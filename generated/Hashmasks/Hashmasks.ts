...
export class Hashmasks extends ethereum.SmartContract {
  static bind(address: Address): Hashmasks {
    return new Hashmasks("Hashmasks", address);
  }

  HASHMASKS_PROVENANCE(): string {
  ...
  try_HASHMASKS_PROVENANCE(): ethereum.CallResult<string> {
  ...
  MAX_NFT_SUPPLY(): BigInt {
    let result = super.call("MAX_NFT_SUPPLY", "MAX_NFT_SUPPLY():(uint256)", []);

    return result[0].toBigInt();
  }

  try_MAX_NFT_SUPPLY(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MAX_NFT_SUPPLY",
  ...
  isMintedBeforeReveal(index: BigInt): boolean {
    let result = super.call(
      "isMintedBeforeReveal",
      "isMintedBeforeReveal(uint256):(bool)",
  ...
  try_isMintedBeforeReveal(index: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isMintedBeforeReveal",
      "isMintedBeforeReveal(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(index)]
...
export class FinalizeStartingIndexCall extends ethereum.Call {
  get inputs(): FinalizeStartingIndexCall__Inputs {
    return new FinalizeStartingIndexCall__Inputs(this);
  }

  get outputs(): FinalizeStartingIndexCall__Outputs {
    return new FinalizeStartingIndexCall__Outputs(this);
  }
}

export class FinalizeStartingIndexCall__Inputs {
  _call: FinalizeStartingIndexCall;

  constructor(call: FinalizeStartingIndexCall) {
    this._call = call;
  }
}

export class FinalizeStartingIndexCall__Outputs {
  _call: FinalizeStartingIndexCall;
